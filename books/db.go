...
func getItem(isbn string) (*book, error) {
	...
	// We can use the UnmarshalMap helper to parse this straight into the fields of a struct.
	// Note: UnmarshalListOfMaps also exists if you are working with multiple items.
	bk := new(book)
